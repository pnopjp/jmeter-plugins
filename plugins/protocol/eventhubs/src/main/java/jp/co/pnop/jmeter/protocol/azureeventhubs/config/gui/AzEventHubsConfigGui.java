...
package jp.co.pnop.jmeter.protocol.azureeventhubs.config.gui;
...
public class AzEventHubsConfigGui extends AbstractConfigGui implements ChangeListener {

    private static final long serialVersionUID = 1L;
    private static final Logger log = LoggerFactory.getLogger(AzEventHubsConfigGui.class);
    ...
    /*
     * Default constructor for AzEventHubsConfigGui
     */
    public AzEventHubsConfigGui() {
        this(true);
    }

    /*
     * Constructor for AzEventHubsConfigGui
     * 
     * @param displayName
     *            flag, whether to show the display name of the component.
     */
    public AzEventHubsConfigGui(boolean displayName) {
    ...
    public String getStaticLabel() {
        return "Azure Event Hubs Defaults";
    }
    ...
    public void modifyTestElement(TestElement element) {
        ...
        element.setProperty(AzEventHubsSampler.NAMESPACE_NAME, namespaceName.getText());
        element.setProperty(AzEventHubsSampler.SHARED_ACCESS_KEY_NAME, sharedAccessKeyName.getText());
        element.setProperty(AzEventHubsSampler.SHARED_ACCESS_KEY, sharedAccessKey.getText());
        element.setProperty(AzEventHubsSampler.EVENT_HUB_NAME, eventHubName.getText());
        element.setProperty(AzEventHubsSampler.PARTITION_TYPE, partitionType.getText());
        element.setProperty(AzEventHubsSampler.PARTITION_VALUE, partitionValue.getText());
        element.setProperty(new TestElementProperty(AzEventHubsSampler.MESSAGES, messagesPanel.createTestElement()));
    }
